...
const intersectionObserverOptions = {
    ...
    rootMargin: "-25px", //Works like CSS margin (but needs to be expressed in percentage or px, as a string).
}
...
function symptomCardContents(id) {
    ...
    const symptomContents7 = "Manual therapy can be related to tight muscles in the face, neck, shoulders, and pelvis and can be related to teeth grinding, history of dental work or dental surgeries, and frequent sinus or ear infections."
...
function inputConsult() {
    ...
    if (window.location.href.includes("/pages/contact.html#consult")) {
        ...
        contactFormMessage.innerText = "Hi Michelle! I'd love to organize a time with you for a consultation call."
