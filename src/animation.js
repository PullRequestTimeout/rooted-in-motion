...
function symptomCardContents(id) {
    // console.log(id)
    const symptomContents1 = "Manual therapy works with muscles, joints, and fascia (connective tissue surrounding muscles, joints, and organs) of the head, neck, and spine and may help decrease the frequency of headaches and migraines and may help with neurological symptoms like tinnitus, vertigo, and insomnia and help with rehabilitation after concussions."
